      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">
            Manage Your AI Assistant Plane and Usage.
          </p>
        </div>
              ...
              {user?.plan === "free"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                  ...
                  <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                    ...
                    <h2 className="text-2xl font-bold text-[#081028]">Free Plane</h2>
                  ...
                  <div className="rounded-3xl p-8 bg-linear-to-r from-purple-600 to-emerald-500 text-white shadow-lg">
                       <h2 className="text-2xl font-bold text-[#081028]">Pro Plane</h2>
                        ...
                        ${user?.plan === "pro" 
                          ? "bg-emerald-200 text-black cursor-default"
                           : "bg-white text-[#081028] cursor-pointer"}`}>
                            {user?.plan === "pro" ? "Active Plane" : "Upgrade Now"}
                           </button>
