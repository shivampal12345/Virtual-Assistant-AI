    ...
    <div className="min-h-screen bg-linear-to-br from-purple-50 via-white to-emerald-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-200
                    bg-purple-100 text-purple-600 text-sm font-medium"
            >
              <HiOutlineSparkles />
            ...
            <button
              className="mt-10 h-16 px-8 rounded-2xl bg-linear-to-r from-purple-500 to-emerald-500 text-white
                    text-lg font-semibold flex items-center gap-4 shadow-[0_20px_80px_rgba(139,92,246,0.25)] hover:scale-[1.02]
          ...
          <div className="relative">
            ...
            <div
              className="relative rounded-[40px] border border-black/5 bg-white shadow-[0_20px_80px_rgba(0,0,0,0.06)]
                        p-8 overflow-hidden"
            >
              <div className="flex items-center justify-between">
                ...
                <div
                  className="w-16 h-16 rounded-3xl bg-linear-to-r from-purple-500 to-emerald-500 flex
                                items-center justify-center shadow-[0_10px_40px_rgba(132,92,246,0.25)] p-3"
                >
                  <img
                    src={logo}
                    alt="logo"
              ...
              <div className="mt-10 space-y-5">
                {FEATURES.map(({ icon, title, desc }, index) => (
                  <div
                    key={index}
                    className="flex gap-5 rounded-3xl border border-black/5
                                        bg-[#f8fafc] p-5"
                  >
                    <div
                      className="min-w-[60px] h-[60px] rounded-2xl bg-linear-to-r from-purple-500
