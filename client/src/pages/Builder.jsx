      ...
      <div className="max-w-4xl mx-auto">
        ...
        {user?.isSetupComplete && !editAssistant && (
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 mb-6">
            <p className="text-sm text-shadow-gray-400">Assistant</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              <div className="rounded-2xl border border-gray-100 bg-[#f8fafc] p-4">
                <p className="text-sm text-gray-400 ">Current Plane</p>
         ...
         <script src="${CLIENT_URL}/assistant.js" "data-user-id=${user?._id}"></script>
            ...
            <div className="relative">
              <textarea
                readOnly
                value={embedCode}
                className="w-full h-20 bg-[#0b1020] text-emerald-400 rounded-2xl p-4 text-sm
              font-mono resize-none outline-none"
              />
              <button
                className="absolute top-4 right-4 w-10 h-10 rounded-xl bg-white flex items-center
              justify-center"
                onClick={() => {
            ...
            <button
              className="mt-6 h-12 px-6 rounded-2xl bg-linear-to-r from-purple-500 to-emerald-500
          ...
          <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {THEMES.map((item) => (
                    <button
                      key={item}
                      className={`py-3 rounded-2xl border capitalize
                    ${
                      theme === item
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-5 gap-4 flex-wrap">
                ...
                <a
                  ...
                  className="px-4 py-2 rounded-xl bg-linear-to-r from-purple-500 to-emerald-500 text-white text-sm
              font-medium hover:scale-[1.02] transition-all cursor-pointer"
                >
                  Get API KEY
                </a>
              </div>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-5 flex-wrap">
                ...
                <button
                  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-linear-to-r from-purple-500
              to-emerald-500 text-white text-sm cursor-pointer"
                  onClick={addPage}
                >
                  <FiPlus />
                  Add
                ...
                {pages.map((page, index) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        {(page.keywords || page.keyWords || []).join(", ")}
                      </p>
                    </div>
                    <button
            ...
            <button
              ...
              className="w-full h-14 rounded-2xl bg-linear-to-r from-purple-500 to-emerald-500 text-white
