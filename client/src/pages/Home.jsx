  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] overflow-hidden">
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="flex justify-center">
            <span
              className="inline-flex items-center gap-2 bg-white border border-purple-100 shadow-sm text-purple-600
          ...
          <div className="text-center mt-10 sm:mt-12">
            <h1
              className="max-w-5xl mx-auto text-[42px] leading-[52px] sm:text-6xl sm:leading-[72px] lg:text-7xl lg:leading-[88px]
            ...
            <p className="max-w-2xl mx-auto mt-7 text-sm sm:text-lg lg:text-xl text-[#64748b] leading-relaxed px-2">
              Create a smart voice-enable Assistant that talks to visitors,
              answers questions and help users navigate Your website instantly.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
              <button
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-linear-to-r from-purple-500 to-emerald-500 text-white
              font-semibold text-sm sm:text-base shadow-[0_12px_40px_rgba(168,85,247,0.25)] hover:scale-[1.02]
            ...
            <p className="mt-5 text-xs sm:text-sm text-gray-400">
              Free Plane Includes 200 AI Responses
            </p>
          </div>
          <AssistantPreview/>
        </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-20 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              {STEPS.map((s,i)=>(
                <div key={i} className="group bg-[#f8fafc] hover:bg-white border border-gray-100 rounded-[28px] p-7
                transition-all hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)]">
                  <span className="text-4xl font-black text-transparent bg-clip-text bg-linear-to-r from-purple-500
      ...
      <footer className="bg-[#081028] px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5 text-center
        sm:text-left">
          <div>
            <div
                      onClick={() => navigate("/")}
